<?php
include '../includes/db.php'; // Asegúrate de tener la conexión correcta a la base de datos
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->rowCount() > 0) {
        ...
        // Insertar nuevo usuario con rol de administrador
...
<body>
    <div class="container">
        <h2 class="mt-5">Registro Administrador</h2>
