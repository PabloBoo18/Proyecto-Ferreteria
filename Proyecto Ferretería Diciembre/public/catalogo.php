<?php
// Remover session_start() aquí si ya está en navbar.php
include '../includes/db.php';

// Si no es una solicitud Ajax, continuar cargando el HTML completo
include 'navbar.php';  // Incluir el navbar solo si es una solicitud normal
...
<body>
    <section class="container">
        <h2 class="mt-5">Catálogo de Productos</h2>
            ...
            <?php foreach ($productos as $producto): ?>
                <section class="col-md-4">
                    <section class="card mb-4">
                        <img src="../img/<?php echo htmlspecialchars($producto['imagen']); ?>" class="card-img-top" alt="Producto">
                        <section class="card-body">
                            ...
                            <a href="detalle_producto.php?id=<?php echo $producto['id_producto']; ?>" class="btn btn-info">Ver detalles</a>
                        </section>
                    </section>
                </section>
            <?php endforeach; ?>
